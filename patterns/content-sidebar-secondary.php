...
<!-- wp:group {"metadata":{"name":"<?php esc_attr_e('Secondary Content Pattern', 'systempress'); ?>"},"className":"py-4 m-0","backgroundColor":"bs-secondary-bg","layout":{"type":"constrained"}} -->
<div class="wp-block-group py-4 m-0 has-bs-secondary-bg-background-color has-background">
