...
<!-- wp:group {"align":"wide","style":{"spacing":{"padding":{"top":"var:preset|spacing|20","bottom":"var:preset|spacing|20","left":"var:preset|spacing|30","right":"var:preset|spacing|30"}}},"backgroundColor":"bs-secondary-bg","className":"shadow-sm my-0","layout":{"type":"constrained","justifyContent":"center"}} -->
<div class="wp-block-group shadow-sm my-0 alignwide has-bs-secondary-bg-background-color has-background" style="padding-top:var(--wp--preset--spacing--20);padding-right:var(--wp--preset--spacing--30);padding-bottom:var(--wp--preset--spacing--20);padding-left:var(--wp--preset--spacing--30)">

    <!-- wp:group {"align":"wide","layout":{"type":"flex","flexWrap":"wrap","justifyContent":"center"}} -->
    <div class="wp-block-group alignwide"><!-- wp:site-logo {"width":60,"style":{"layout":{"selfStretch":"fit","flexSize":null}}} /-->
        ...
        <div class="wp-block-group alignwide">
            ...
            <div class="wp-block-group" style="margin-top:var(--wp--preset--spacing--20)">
                ...
                <!-- wp:group {"className":"dark-mode dropdown dropstart","style":{"spacing":{"margin":{"top":"var:preset|spacing|10"}}},"layout":{"type":"flex","orientation":"horizontal"}} -->
                <div class="wp-block-group dark-mode dropdown dropstart" style="margin-top:var(--wp--preset--spacing--10)">
