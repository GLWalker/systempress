...
<div class="wp-block-group jumbotron-full my-5"><!-- wp:group {"align":"wide","backgroundColor":"bs-secondary-bg","className":"p-4 text-center","layout":{"type":"default"}} -->
    <div class="wp-block-group alignwide p-4 text-center has-bs-secondary-bg-background-color has-background"><!-- wp:group {"className":"container py-4","layout":{"type":"constrained"}} -->
        <div class="wp-block-group container py-4"><!-- wp:heading {"textAlign":"center","className":"text-body-emphasis","fontSize":"display-3"} -->
