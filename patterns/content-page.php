...
/**
 * Title: Content Page
 * Slug: systempress/content-page
 * Inserter: no
 */
?>
<!-- wp:group {"tagName":"article","metadata":{"name":"<?php esc_attr_e(' Content Page Pattern', 'systempress'); ?>"},"align":"full","className":"hentry","style":{"spacing":{"padding":{"top":"var:preset|spacing|40","bottom":"var:preset|spacing|40"}}},"layout":{"type":"constrained"}} -->
